...
function startConversation() {
    fetch('https://chatbot-for-barnes-day-care-samuelsicking.replit.app/start', {
        method: 'GET'
    })
    .then(response => response.json())
    .then(data => {
...
document.getElementById('chat-form').addEventListener('submit', function(event) {
    ...
    fetch('https://chatbot-for-barnes-day-care-samuelsicking.replit.app/chat', {
        method: 'POST',
        headers: {
...
function sendToGas4(message, isUserMessage) {
    ...
    const GAS_URL4 = 'https://script.google.com/macros/s/AKfycbz45ChVIMqu-OYXGBPJjcnkOqGbeo7A3Dafa8HgBR_smc9G1hbOCDXzEtyPh8j-9tWj/exec';
